const message = {
    ...
    "string.empty":"no está permitido que sea vacío",
...
const messageId = {
    "any.required" : "Es nacesario un id para esta operación",
    "number.max" : "Se sobrepaso el maximo de caracteres aceptados en el id",
    "number.length.min" : "No se alcanzo la cantidad minima de caracteres requeridos para el id"
};

const email = {
    "registeredSussefully" : "Gracias por registrarte :D!!",    
    "emailSender" : "<noreply>remitente<noreply>",    
    
};
module.exports={message,messageId,email};